      ...
      <div className="App__container">
        <div className="App__list-container list">
          <div className="list__content">
            ...
            <TodoList todos={todos} deleteTodo={deleteToDo} completed={completed} edit={edit} setValue={setValue} setEdit={setEdit} submitEdits={submitEdits} editingText={editingText} />
          </div>
        </div>
      </div>
    </div>
